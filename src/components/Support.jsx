...
const supports = [
  {
    ...
    link: 'https://github.com/vsmidhun21/DevIgnite/issues',
    label: 'Open an Issue →',
    color: '#6366f1',
  ...
  },
  {
    ...
    link: 'https://github.com/vsmidhun21/DevIgnite#readme',
  ...
  //   link: 'https://github.com/vsmidhun21/DevIgnite/discussions',
