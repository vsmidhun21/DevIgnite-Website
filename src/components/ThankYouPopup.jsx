          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1, padding: '12px' }}>
              ...
              <p style={{ color: 'var(--text-muted)', marginBottom: '32px', lineHeight: 1.6 }}>
                ...
                <a href="https://github.com/vsmidhun21/DevIgnite/releases/download/v3.1.0/DevIgniteSetup-v3.1.0.exe" style={{ color: 'var(--accent-brand)', marginLeft: '4px', textDecoration: 'underline' }}>click here</a>.
              </p>
